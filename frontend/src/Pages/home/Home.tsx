    ...
    <div className="w-full h-full flex flex-col items-center">
      <div className="max-w-5xl w-11/12 flex flex-col items-center">
        <div className="min-h-screen pt-20 pb-4 flex items-center justify-center">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-4 justify-items-center justify-center z-10">
            <div className="flex flex-col gap-6 justify-center">
              <h2 className="dark:text-white font-varela text-3xl font-bold uppercase text-center">
                Pest
                {' '}
                <span className="dark:text-white">Detection</span>
              </h2>
              <p className="dark:text-white font-varela text-center">
              ...
              <div className="flex justify-center items-center gap-4">
                ...
                <button
                  ...
                  className="dark:bg-transparent dark:text-white font-bold underline text-black font-varela"
                >
                  Learn More
                </button>
              </div>
              <div className="dark:bg-transparent dark:text-white font-varela text-lg text-center">
                Pests identified:
                {' '}
        ...
        <div ref={featuresRef} className="min-h-screen flex flex-col items-center justify-center gap-8 pb-4">
          <h2 className="dark:text-white text-4xl font-bold font-varela">Having a problem identifying winged pests?</h2>
          <p className="dark:text-white max-w-prose font-varela">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="grid grid-cols-[1fr_5fr] gap-4 items-center">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="dark:text-white font-varela">Users can drag and drop images for scanning, significantly increasing flexibility.</p>
              </div>
            </div>
            <div className="grid grid-cols-[1fr_5fr] gap-4 items-center">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="dark:text-white font-varela">Users can upload multiple images with no limits providing efficiency. </p>
              </div>
            </div>
            <div className="grid grid-cols-[1fr_5fr] gap-4 items-center">
            ...
            <div className="grid grid-cols-[1fr_5fr] gap-4 items-center">
              ...
              <div className="ml-3 text-left max-w-xs">
                ...
                <p className="dark:text-white font-varela">Users who are logged in can view previous predictions which are stored on a database. </p>
              </div>
            </div>
          </div>
        </div>
